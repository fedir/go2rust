...
A lightweight REST API built with Go and the Gin framework. It traces and stores arbitrary JSON payloads as local files for easy debugging and data collection.
...
### 2. Launch the Server
From the project root (`goau` folder):
```bash
